...
export function LiquidMetalButton({
  ...
  useEffect(() =&gt; {
    ...
    if (!document.getElementById(styleId)) {
      ...
      [style.id](http://style.id) = styleId;
  ...
  const handleClick = (e: React.MouseEvent&lt;HTMLButtonElement&gt;) =&gt; {
    ...
    if (buttonRef.current) {
      ...
      const y = e.clientY - [rect.top](http://rect.top);
      ...
      setTimeout(() =&gt; {
        ...
        setRipples((prev) =&gt; prev.filter((r) =&gt; [r.id](http://r.id) !== [ripple.id](http://ripple.id)));
      ...
      &gt;
        ...
        &gt;
          ...
          &gt;
            ...
            {[ripples.map](http://ripples.map)((ripple) =&gt; (

              &lt;span

                key={[ripple.id](http://ripple.id)}
